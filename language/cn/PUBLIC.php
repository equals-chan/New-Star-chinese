...
$LNG['nav_news']					                 = 'News';
$LNG['nav_rules']					                 = 'Rules';
$LNG['nav_banlist']				                     = 'Banned Hall';
$LNG['nav_battlehall']				                 = 'Battle Hall';
$LNG['nav_disclamer']				                 = 'Contacts';
$LNG['nav_register']				                 = 'Registration';
$LNG['nav_password']				                 = 'Lost Password?';
...
$LNG['loginScreens']                                 = 'Hey! Do not ignore me! You will miss such a best gallery!';
//{IDs_0005} Register
$LNG['registerUsername']			                 = 'Username';
$LNG['registerUsernameDesc']		                 = 'Your username must be at least 3 characters long and not longer than 25. It may consist of numbers, letters, _, -, . and spaces only.';
$LNG['registerPassword']			                 = 'Password';
$LNG['registerPasswordDesc']		                 = 'Your password must be at least 6 characters long.';
$LNG['registerPasswordReplay']		                 = 'Confirm Password';
$LNG['registerPasswordReplayDesc']	                 = 'Please repeat your password.';
$LNG['registerEmail']				                 = 'E-Mail';
$LNG['registerEmailDesc']			                 = 'Please enter your E-Mail address.';
$LNG['registerEmailReplay']			                 = 'Confirm E-Mail';
$LNG['registerEmailReplayDesc']		                 = 'Please enter your E-Mail address once again for the security.';
...
$LNG['registerErrorUsernameChar']	                 = 'Your username may consist of numbers, letters, _, -, . and spaces only!';
$LNG['registerErrorUsernameExist']  	             = 'This username is already taken!';
$LNG['registerErrorPasswordLength']	                 = 'The password must be at least 6 characters long!';
$LNG['registerErrorPasswordSame']	                 = 'Entered passwords do not match!';
...
$LNG['registerSendComplete']		                 = 'Thank you for the registration. You must check your email (Attention with the SPAM) for further information.';
...
$LNG['passwordErrorOnePerDay']		                 = 'New password for this user account was recently requested. You can only reset your password once per 24 hours.';
...
$LNG['login_error_2']				                 = 'Someone has logged in from a different PC to your account, or your IP changed!';
